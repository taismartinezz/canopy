...
function formatDateLabel(date: string): string {
  ...
  const today = todayStart(); const tmrw = new Date(today); tmrw.setDate(today.getDate()+1);
...
function DateTimeFields({ selDate, selTime, showTime, accentColor, onDateChange, onTimeChange, onToggleTime, onRefocus }: {
